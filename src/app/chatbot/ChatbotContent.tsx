        ...
        >
          <div className="relative w-full aspect-[16/9] rounded-2xl overflow-hidden border border-[var(--card-border)] shadow-2xl">
            <Image
              ...
              alt="AI chatbot voor makelaars — homeowner stelt vraag via chat"
              fill
              priority
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center mb-12">
            ...
            >
              <Image
                ...
                alt="Laptop met chatbot widget voor makelaar website"
                fill
                className="object-cover"
            ...
            >
              ...
              <p className="text-foreground-accent leading-relaxed">De chatbot is getraind op typische makelaar-vragen. Hij weet wanneer een aanvraag spoed is en triggert direct een actie — geen leads die `'`s nachts verdampen.</p>
            </motion.div>
          </div>
