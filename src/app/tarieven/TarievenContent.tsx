...
const plans = [
  ...
  },
  {
    ...
    price: "€79",
    period: "/maand",
    description: `De ideale start voor jouw ${nicheSingular}sbedrijf. Website, SEO en AI-tools — beheerd door AI.`,
    features: [
...
const faqs = [
  ...
  },
  {
    ...
    a: `Een volledig beheerd systeem: 1 SEO-blogartikel per week, AI Chatbot, Voice AI, social media tools en een maandelijkse strategie call van 15 minuten. De ideale start om vindbaar te worden en te groeien als ${nicheSingular}sbedrijf.`,
  },
  {
